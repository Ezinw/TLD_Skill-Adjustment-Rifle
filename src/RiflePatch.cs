...
namespace SkillAdjustmentRifle
{
    ...
    internal class RifleAdjustmentXP
    {
        public static void Postfix(SkillsManager __instance)
        {
            ...
            if (rifleSkill != null)
            {
                rifleSkill.m_TierPoints[1] = Settings.settings.tier2;
                rifleSkill.m_TierPoints[2] = Settings.settings.tier3;
                rifleSkill.m_TierPoints[3] = Settings.settings.tier4;
                rifleSkill.m_TierPoints[4] = Settings.settings.tier5;
            }
        }
    }
