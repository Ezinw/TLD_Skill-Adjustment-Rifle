...
namespace SkillAdjustmentRifle
{
    internal class Settings : JsonModSettings
    {
        ...
        internal void RefreshFields()
        {
            ...
            SetFieldVisible(nameof(tier2), Rifle2 && Rifle);
            ...
            SetFieldVisible(nameof(tier3), Rifle3 && Rifle);
            ...
            SetFieldVisible(nameof(tier4), Rifle4 && Rifle);
            ...
            SetFieldVisible(nameof(tier5), Rifle5 && Rifle);
